...
const DOMAIN_NAME = 'dongyidongnan.github.io' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    // defaultMode: 'auto',
    repo: '/dongyidongnan/pb-doc', // Github仓库地址
    ...
    author: {
      name: 'pb', // 必需
      link: 'https://github.com/dongyidongnan', // 可选的
    },
